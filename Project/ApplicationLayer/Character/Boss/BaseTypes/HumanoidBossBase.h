...
protected: /// ---------- モデルパス取得 ---------- ///
	...
	virtual std::string GetBodyModelPath() const { return "Character/body.gltf"; }
	virtual std::string GetHeadModelPath() const { return "Character/head.gltf"; }
	virtual std::string GetLeftArmModelPath() const { return "Character/left_arm.gltf"; }
	virtual std::string GetRightArmModelPath() const { return "Character/right_arm.gltf"; }
	virtual std::string GetLeftLegModelPath() const { return "Character/left_leg.gltf"; }
	virtual std::string GetRightLegModelPath() const { return "Character/right_leg.gltf"; }
