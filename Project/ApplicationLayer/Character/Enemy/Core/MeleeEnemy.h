...
private:
	...
	float obstacleExpandRadius_ = 0.9f;
	float temporaryBlockDuration_ = 1.5f;
	float temporaryBlockRadius_ = 1.0f;
	bool cornerCuttingDisabled_ = true;
	float pathFailedWaitTimer_ = 0.0f;
