...
// Early work-in-reloadProgress API for ScrollToItem()
...
{
    ImGuiID                 ID;
    ImS8                    QueryFrameCount;            // >= 1: Query in reloadProgress
...
namespace ImGui
{
    ...
    // Early work-in-reloadProgress API (ScrollToItem() will become public)
